...
const Empowerment = () => {
  ...
  return (
    <>
      <SEO 
        title="Women Empowerment - Self-Help Group Services | Jaagat Janni Mahila Bikash Foundation"
        description="Women Empowerment programs by Jaagat Janni Mahila Bikash Foundation - Complete self-help group services including SHG formation, savings schemes, loan schemes, training programs for women in Patna and Muzaffarpur, Bihar"
